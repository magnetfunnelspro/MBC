...
import { trackRemoveFromCart } from "../../utils/metaPixel";
...
const Cart = () => {
  ...
  return (
    <>
      {/* SEO + Meta Tags */}
      <Helmet>
        <title>Your Cart | Main Bhi Cockroach</title>

        <meta
          name="description"
          content="Review your cart and checkout your favorite meme t-shirts from Main Bhi Cockroach."
        />

        <meta property="og:title" content="Your Cart | Main Bhi Cockroach" />

        <meta
          property="og:description"
          content="Checkout viral t-shirts inspired by internet chaos and Gen-Z culture."
        />

        <meta property="og:type" content="website" />

        <meta property="og:image" content="/TeeFront.webp" />
      </Helmet>
          ...
          <div className="bg-brown text-cream rounded-2xl p-8 flex flex-col items-center text-center gap-4">
            ...
            <div>
              ...
              <p className="opacity-80 mt-2">
                Add some cockroach-powered drip.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col justify-between gap-6">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-4">
                      ...
                      >
                        Remove <i className="ri-delete-bin-5-line"></i>
                      </button>
                    </div>
                  </div>
                </div>
